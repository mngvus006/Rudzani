export const blogPostData = [
{
    ...
    bannerSubTitle: "Sihle Hlophe is a SAFTA-winning filmmaker and a multi-degree earner. Over the last 12 years, her work has been recognised with a number of accolades.",
    youtubeLink: "https://www.youtube.com/watch?v=5YkAojPGcew",
    mainTitle: "Sihle Hlophe - If I don’t vibe with a story on an energetic level and it’s not aligned with my values, then that story is probably not for me to tell.",
    paragraphs: [
    "Sihle Hlophe is a multi-award-winning director, screenwriter, and holder of multiple degrees. Her company, Passion Seed Communications, is a film-based social venture that she founded and executive produces. Hlophe is a graduate of the Netherlands' IDFAcademy, Finland's North-South-South Student Exchange Program, and Canada's Hot Docs Blue Ice Group Story Lab. Her work has garnered various awards over the last 14 years, including two African Movie Academy Award Nominations for Best Documentary.",
    "Sihle grew up in KaNyamazane, a township on the outskirts of Nelspruit in the Mpumalanga province. \"I was in every school play when I was younger. I was interested in art, history, music, and theatre. I was also a huge fan of Steven Spielberg, Spike Lee, and Hype Williams\", Hlope states. She wanted to be a fashion designer at first, then a psychologist. She is attracted by art as well as human nature, and she believes that directing allows her to blend all her interests. She says she has always been curious, and that others around her encouraged her inquisitive nature and voracious thirst for knowledge.",
    ...
    "The auteur attended her first international film festival in 2015, the Pan African Film Festival in Los Angeles. The festival was arranged LAX, and the auteur was thrilled to attend the opening night alongside legendary director Stanley Nelson and Mama Nike Davies-Okundaye. She remembers the red carpet packed with journalists, festival attendees, and filmmakers, making the event a dream come true. The organization and the fact that the journalists already had briefs with their names and countries of origin struck the auteur. She encountered surviving Black Panthers members at the cocktail party, who screamed 'Mandela, Mandela' as they posed for photos. This experience was a watershed moment in the auteur's life, strongly validating and encouraging her to pursue her dreams.",
    "She is the producer and director of the feature-length documentary, <a href='https://www.imdb.com/title/tt21932674/?ref_=nm_knf_t_1' target=”_blank”> ‘Lobola, A Bride’s True Price’</a>, which won the Most Outstanding Documentary Project award at the Durban Film Mart in 2017. Hlophe directed, Lindela Under Lockdown in 2020, which won the Best Documentary Award at the Cameroon International Film Festival and the Best Documentary Short Award at the South African Film & Television Awards (SAFTAs). In 2021, Hlophe directed and produced Celebrating Herstory Through Song in 2022. Hlophe has directed two feature-length Showmax Original made for-TV fiction films, Pearls Of Wisdom and Expiry Date. Hlophe is also the director of African Dreams premiered in 2021, a SAFTA-winning 13-part mocku-series that aired on SABC 1.",
    "For a long time, racism and sexism have been issues in the film industry. Positive changes have occurred in the last ten years, as evidenced by organizations such as SWIFT. Hlope would like to see more women in technical roles like as sound recordists, gaffers, grips, editors, colorists, music composers, and so on, as well as more diversity and inclusion on our screens. \"Why, for example, are the majority of romantic leads on our screens thin and heterosexual?\" Why is it still uncommon to see a character speaking a minority language on mainstream television? We've still got a long way to go. We're still being cautious. We must continue to push the boundaries”. Sihle expresses her willingness to promote any minority language or minority group that is underrepresented in the media.",
    "Hlope truly believes that storytelling is a deeply spiritual undertaking. “You are ordained by a higher power and in some instances, those who came before you, to tell a certain story and sometimes, that story can change lives and be a catalyst for social change. All of these things are beyond your control as a filmmaker. You make the film and put it out there… the rest is up to that higher power. I firmly believe that intentions and energy matter. If I don’t vibe with a story on an energetic level and it’s not aligned with my values, then that story is probably not for me to tell”.",
    "Hlophe co-produced Sadla, a narrative short film that premiered in 2020 at the Sundance Film Festival in the United States. Hlophe has written and directed two award-winning narrative short films,<a href='https://www.imdb.com/title/tt4128166/?ref_=nm_knf_c_2' target=”_blank”> As I Am  in 2014 </a>and <a href='https://www.imdb.com/title/tt6727514/?ref_=nm_knf_c_4' target=”_blank”> Nomfundo in 2017</a>, which have been shown at over 40 film festivals worldwide. She has also worked as a playwright and storyliner on award-winning TV dramas like Lockdown, Scandal, Mutual Friends, and Broken Vows between 2012 and 2017. She has also worked part-time as a lecturer at AFDA  in 2016 and the University of Johannesburg in 2018 and 2019.",
    "Sihle Hlope would like to be remembered for being a beautiful soul who made beautiful, thought-provoking films that create social change."

    ],
    profileImage: require("./RuImages/SihleHlophe/Profile.png"),
    bannerImage: require("./RuImages/SihleHlophe/Banner.png"),
    carouselImages: [
      require("./RuImages/SihleHlophe/1.png"),
      require("./RuImages/SihleHlophe/2.png"),
      require("./RuImages/SihleHlophe/3.png"),
      require("./RuImages/SihleHlophe/4.png"),
    ],
  },
 {
     id: 2,
