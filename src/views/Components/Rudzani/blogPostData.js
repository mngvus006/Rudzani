export const blogPostData = [
  {
    ...
    bannerSubTitle: "“I’m the kind of filmmaker who doesn’t want to repeat or recycle any signatures or symbols in the films I do because I do not want to be predicted by someone else who has been following my works.”",
    ...
    paragraphs: [
         "Kizito Samuel Saviour has worked in several fields in the film production including producing, Script writing, directing, cinematography and film editing, for films including <Link href=\"https://youtu.be/ZdEQs9YYklg\"> NKWANZI’S SLIP (2023)</Link>, MANIA (2022), Your Turn (2022), Catch Out (2021), KEMI (2020) and others, that picked up over 130 international nominations and over 30 international awards from film festivals and awarding platforms from all over the world.",
